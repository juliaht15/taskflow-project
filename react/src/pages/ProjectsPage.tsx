      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Organiza tus tareas por proyectos para mantener el enfoque.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="border-2 border-dashed border-gray-300 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 cursor-pointer bg-transparent dark:bg-gray-800/50">
          ...
          {projects.map((project) => (
            <Card key={project.id} className="hover:shadow-lg transition-shadow dark:bg-gray-800 dark:border-gray-700">
