        ...
        <div className="flex items-start gap-3 flex-1">
          ...
          >
            {task.completed ? (
              ...
              <Circle className="w-6 h-6 text-gray-300 hover:text-wix-accent transition-colors" />
            )}
          </button>

          <div className="flex-1">
            <h3 className={`text-lg font-semibold mb-2 ${task.completed ? 'line-through text-gray-400' : 'text-gray-900'}`}>
              {task.title}
            </h3>
