      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
              <div className="p-2 rounded-xl bg-linear-to-r from-indigo-500 to-purple-600 shadow-md group-hover:shadow-lg transition-all duration-300">
          ...
          <div className="px-4 py-4 space-y-2">
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full flex items-center gap-2 px-4 py-3 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300"
              >
